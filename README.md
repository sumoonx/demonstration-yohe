...
### Just editing
This is about the editing style, which makes the code clean an readable.
...
#### More about coding
Here's still some other basic rules we might want to obey, we'll discuss that later.
